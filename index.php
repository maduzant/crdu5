...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($ram && $nama && $harga && $warna) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update mahasiswa set ram = '$ram',nama='$nama',harga = '$harga',warna='$warna' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into mahasiswa(ram,nama,harga,warna) values ('$ram','$nama','$harga','$warna')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
